...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BINLIBDEST': '/opt/python/lib/python2.7',
 ...
 'CONFIG_ARGS': "'--prefix=/opt/python' '--enable-shared' '--enable-ipv6' '--enable-unicode=ucs4' '--with-system-ffi' '--with-system-expat'",
 'CONFINCLUDEDIR': '/opt/python/include',
 'CONFINCLUDEPY': '/opt/python/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'COVERAGE_INFO': '/tmp/Python-2.7.16/coverage.info',
 'COVERAGE_REPORT': '/tmp/Python-2.7.16/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov report"',
 'CPPFLAGS': '-I. -IInclude -I./Include',
 'CXX': 'g++ -pthread',
 'C_THREADS': 0,
 'DESTDIRS': '/opt/python /opt/python/lib /opt/python/lib/python2.7 /opt/python/lib/python2.7/lib-dynload',
 'DESTLIB': '/opt/python/lib/python2.7',
 'DESTPATH': '',
 'DESTSHARED': '/opt/python/lib/python2.7/lib-dynload',
 'DIRMODE': 755,
 ...
 'HURD_C_THREADS': 0,
 'INCLDIRSTOMAKE': '/opt/python/include /opt/python/include /opt/python/include/python2.7 /opt/python/include/python2.7',
 'INCLUDEDIR': '/opt/python/include',
 'INCLUDEPY': '/opt/python/include/python2.7',
 ...
 'LIBC': '',
 'LIBDEST': '/opt/python/lib/python2.7',
 'LIBDIR': '/opt/python/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBP': '/opt/python/lib/python2.7',
 'LIBPC': '/opt/python/lib/pkgconfig',
 'LIBPL': '/opt/python/lib/python2.7/config',
 ...
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/python/lib/python2.7',
 'MACH_C_THREADS': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/Python-2.7.16',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/Python-2.7.16 ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/tmp/Python-2.7.16',
 'abs_srcdir': '/tmp/Python-2.7.16',
